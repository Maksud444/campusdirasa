    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      <div className="bg-white border-b border-gray-200 py-4 px-4">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-sm">
          <Link href="/forms" className="text-blue-600 hover:underline">النماذج</Link>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-green-200">
          ...
          <div className="p-12">
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-8 mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-lg">1</div>
                  <div>
                    <h4 className="font-bold text-green-900 mb-1">اضغط على زر التحقق من القبول</h4>
                    <p className="text-green-800">سيتم فتح نموذج Google Forms</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-lg">2</div>
                  <div>
                    <h4 className="font-bold text-green-900 mb-1">أدخل الاسم الكامل</h4>
                    <p className="text-green-800">يجب أن يكون الاسم مطابقاً للوثائق الرسمية</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-lg">3</div>
                  <div>
                    <h4 className="font-bold text-green-900 mb-1">أدخل رقم الجواز</h4>
                    <p className="text-green-800">تأكد من صحة رقم الجواز قبل الإرسال</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-lg">4</div>
                  <div>
                    <h4 className="font-bold text-green-900 mb-1">اضغط على إرسال</h4>
                    <p className="text-green-800">ستظهر النتيجة مباشرة بعد الإرسال</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <a href={googleFormLink} target="_blank" rel="noopener noreferrer" className="block w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white text-center py-6 rounded-xl font-bold text-2xl hover:shadow-2xl transition-all transform hover:scale-105 flex items-center justify-center gap-3">
              <CheckCircle size={32} />
        ...
        <div className="mt-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-10 text-center shadow-2xl">
