...
import { Settings, ArrowLeft, Sliders } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl p-8 shadow-md">
          <div className="text-center py-12">
            <Sliders className="text-gray-300 mx-auto mb-4" size={64} />
            <h2 className="text-2xl font-bold text-gray-800 mb-2">قسم الإعدادات</h2>
